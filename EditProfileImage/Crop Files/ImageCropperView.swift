...
open class ImageCropperView: UIView, UIScrollViewDelegate, UIGestureRecognizerDelegate, ImageCropperOverlayViewDelegate {
    ...
    weak open var delegate: ImageCropperViewDelegate?
    ...
    deinit {
        ...
        #if ImageCropperViewDEBUG
            print("deinit ImageCropperView")
        #endif
    }
...
public protocol ImageCropperViewDelegate : class {
...
public extension ImageCropperViewDelegate {
    func imageCropperViewDidChangeCropRect(view: ImageCropperView, cropRect rect: CGRect) {}
}
