...
open class ImageCropperOverlayView: UIView {
    ...
    fileprivate var activeCropAreaPart: CropAreaPart = .none {
        didSet { layoutSubviews() }
    }
    
    fileprivate struct CropAreaPart: OptionSet {
    ...
    fileprivate func getCropAreaPartContainsPoint(_ point: CGPoint) -> CropAreaPart {
